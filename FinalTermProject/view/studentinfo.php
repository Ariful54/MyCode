...
<button><a href="studentinfo.php">Refresh</a></button>
...
if($_SERVER["REQUEST_METHOD"]=="POST")
{
     ...
     if(!empty($_POST["delete"]))
     {
       ...
       if($result===true)
       {
        $connect->UpdateQuery($conobj,$sql1);
     ...
     else if(!empty($_POST["updateconfirm"]))
     {
       ...
       $sql="UPDATE students SET username='$username',cgpa='$_POST[ucgpa]',gender='$_POST[gender]', email='$_POST[email]' WHERE
       userid='$_POST[uid]'";
       $connect=new db();
       $conobj=$connect->OpenCon();
